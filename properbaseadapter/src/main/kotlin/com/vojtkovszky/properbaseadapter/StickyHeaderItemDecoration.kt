...
class StickyHeaderItemDecoration(
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val contactPointBottom = headerView.bottom + parent.paddingTop
        val childInContact = getChildInContact(parent, contactPointBottom) ?: return
    ...
    private fun getChildInContact(parent: RecyclerView, contactPointBottom: Int): View? {
        return (0 until parent.childCount)
            .map { parent.getChildAt(it) }
            .firstOrNull {
                val childLp = it.layoutParams as RecyclerView.LayoutParams
                it.bottom + childLp.bottomMargin > contactPointBottom
                        && it.top - childLp.topMargin <= contactPointBottom
            }
    }
